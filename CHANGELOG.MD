...
## 3.1.2 -- DEV
- Updated CSS purge
- Updated project type gulp

## 3.1.1
- Fixed gulp del import
- Removed clean task for now
- Fixed symbols generation
- Improved tab trapping
- Added custom tailwind font size variables to remove line heights
- Adjusted link default styling
- Improved cookiebar
- Improved heading styles
- Fixed Nunjucks default settings
- Fixed static Gulp task util

## 3.1.0
- Added three-way development: nunjucks, CraftCMS or shopify.

## 3.0.2
- Removed unused mixins
- Added visible-focus polyfill
- Checking assets directories before running tasks
