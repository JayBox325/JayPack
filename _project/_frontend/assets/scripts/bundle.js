...
/***/ "./_src/scripts/default/header.js":
/*!****************************************!*\
  !*** ./_src/scripts/default/header.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./slider */ "./_src/scripts/modules/slider.js");
...
function slider() {
  ...
  if (sliders.length) {
    slider.forEach(function (el) {
      ...
      if (type == 'slider') {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).slick({
          infinite: true,
          fade: true,
          // Navigation
          dots: true,
